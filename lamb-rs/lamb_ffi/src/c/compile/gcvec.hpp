...
template <typename T> class GcVec {
    u32 capacity;
    u32 _len;
    T *values;
  ...
  public:
    ...
    struct GcVecIter {
        ...
        GcVecIter &operator+=(const difference_type n) {
            (*this) += n;
            return *this;
        }
        ...
        friend difference_type operator-(const GcVecIter &lhs, const GcVecIter &rhs) {
            return lhs.data - rhs.data;
        }

        friend GcVecIter operator+(const GcVecIter &lhs, difference_type rhs) {
            return GcVecIter(lhs.data + rhs);
        }
        friend GcVecIter operator-(const GcVecIter &lhs, difference_type rhs) {
            return GcVecIter(lhs.data - rhs);
        }
        friend GcVecIter operator+(difference_type lhs, const GcVecIter &rhs) {
            return GcVecIter(lhs + rhs.data);
        }
        friend GcVecIter operator-(difference_type lhs, const GcVecIter &rhs) {
            return GcVecIter(lhs - rhs.data);
        }

        friend bool operator==(const GcVecIter &lhs, const GcVecIter &rhs) {
            return lhs.data == rhs.data;
        };
        friend bool operator!=(const GcVecIter &lhs, const GcVecIter &rhs) {
            return lhs.data != rhs.data;
    ...
    constexpr std::reverse_iterator<GcVecIter> rbegin() {
        return std::make_reverse_iterator(this->end());
    }
    constexpr std::reverse_iterator<GcVecIter> rend() {
