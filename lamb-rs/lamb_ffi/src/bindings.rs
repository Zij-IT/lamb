...
pub const AstNodeType_AstntPattern: AstNodeType = 42;
pub const AstNodeType_AstntPatternTopLit: AstNodeType = 43;
pub const AstNodeType_AstntPatternTopIdent: AstNodeType = 44;
